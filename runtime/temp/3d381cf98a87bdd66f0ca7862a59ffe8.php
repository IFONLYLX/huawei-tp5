<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpstudy\WWW\tp4\public/../app/admin\view\index\frame\pages\news_list.html";i:1510024034;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <ul class="list-unstyled">
                     ...
                     <form action="<?php echo url('news/pagesnews_select'); ?>">


                         <input type="text" name="id" placeholder="查找">
            ...
            <div class="container-fluid ">
                <div class="row">
                    ...
                    <tr>
                        ...
                        <?php  echo date("Y-m-d",strtotime($value['create_time']));?>
                        <td><?php echo $value['content']; ?></td>
                        <td class="over"><?php echo $value['contents']; ?></td>
