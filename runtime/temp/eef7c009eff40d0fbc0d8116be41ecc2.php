<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpstudy\WWW\tp5\public/../app/admin\view\index\frame\pages\pic_upload.html";i:1510838813;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="UTF-8">
  ...
  <body>
    <div class="col-sm-12">
      ...
      <form style=" opacity: 0.8;" id="valiForm" class="form-horizontal" action="<?php echo url('upload/uploads'); ?>"   enctype="multipart/form-data" method="post" >
        ...
        <div class="form-group input-group ">
          ...
          <input type="text" class="form-control" name="title" id="title" placeholder="title h3" 
          >
        </div>
        <div class="form-group input-group ">

          <span class="input-group-addon "><span class="glyphicon glyphicon-user"></span></span>
          <input type="text" class="form-control" name="titleid" id="titleid" placeholder="titleid" 
          >
        </div>
        <div class="form-group input-group help">
         <span class="input-group-addon">
           <span class="glyphicon glyphicon-lock"></span></span>
           <input type="text" class="form-control" name="content" id="content" placeholder="内容 p" >           
         </div>
         <div class="form-group input-group help">
           <span class="input-group-addon">
             <span class="glyphicon glyphicon-lock"></span></span>
             <input type="text" class="form-control" name="description" id="description" placeholder="描述 价格" >           
           </div>
           <div class="form-group input-group help container kv-main">
             ...
             <input type="hidden" value="" name="picurl" id="imgPath">
