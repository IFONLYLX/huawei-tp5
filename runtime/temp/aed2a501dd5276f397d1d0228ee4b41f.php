<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\phpstudy\WWW\tp4\public/../app/index\view\index\news.html";i:1509882483;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <div class="text-black">
                    ...
                    <div class="left-main">
                        ...
                        <a href="##" style="font-size:18px;">
                            SDN</a>
                        <a href="##" style="font-size:18px; ">
                            <input type="hidden" value="3"> 4.5G</a>
                        <a href="##" style="font-size:28px; font-weight:500">
                            <input type="hidden" value="4">云计算</a>
                        <a href="##" style="font-size:18px; ">
                            <input type="hidden" value="5">FMC2.0</a>
                        <a href="##" style="font-size:28px; font-weight:500">
                            <input type="hidden" value="6">视频</a>
                        <a href="##" style="font-size:18px; ">
                            <input type="hidden" value="7">GCI</a>
                        <a href="##" style="font-size:28px; font-weight:500">
                            <input type="hidden" value="8">手机</a>
                        <a href="##" style="font-size:20px; ">
                            <input type="hidden" value="9">管理服务</a>
                    </div>
                </div>
                <div class="text-black">
                    <h4>相关链接</h4>
