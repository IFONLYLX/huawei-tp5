<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\phpstudy\WWW\tp5\public/../app/index\view\index\newsinfo.html";i:1510886076;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="container">
    <div class="row">
            ...
            <div class="list-news">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <h3  class="text-blacks"><?php echo $data['title']; ?></h3>

                        <p  class="text-blacks" style="text-indent:2em;"><?php echo $data['contents']; ?></p>
                        <span  class="text-grey"><?php echo date('Y-m-d',strtotime($data['create_time'])); ?></span>
                    </li>
        ...
        <div class="col-sm-3  hidden-xs">
            <div class="container-fluid">
                <div class="split"></div>
                <a href="##" id="dropdowns" class="dropdown-toggle left-nav" data-toggle="dropdown"><span class="glyphicon  glyphicon-triangle-bottom "></span>按日期过滤</a>
