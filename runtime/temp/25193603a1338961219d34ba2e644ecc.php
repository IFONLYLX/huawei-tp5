<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\phpstudy\WWW\tp5\public/../app/index\view\index\index.html";i:1511098732;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
    ...
    function change(a){
        ...
        if (a==1)
         css.setAttribute("href","/tp5/public/static/css/index.css");

     if (a==2)
         css.setAttribute("href","/tp5/public/static/css/en.css");
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <button class="btn btn-primary btn-sm" id="btn" onclick="change(2)"><?php echo lang('切换'); ?></button>
                <?php
                if ($value==null) {
...
<div class="drop-toggle">
    <div class="collapse navbar-collapse" id="responsenav">
        <ul class="nav navbar-nav dropdown-list">
            ...
            <li><a href="<?php echo url('index/mall'); ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo lang('华为商城'); ?></a></li>
        </ul>
...
<div class="index">
    ...
    <div class="container-fluid">
        <div class="content">
            ...
            <div class="grid">
                <figure class="effect-sadie  effect-lily hidden-xs">
